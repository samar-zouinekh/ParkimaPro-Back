...
return [
    ...
    */
    ...
    'auth' => [ // [AAPS]
        ...
        'credentials' => [
            'username' => env('UG_LOGIN', 'medianet'),
            'password' => env('UG_PASSWORD', 'medianet'),
        ],
    ...
    */
    'profiles' => [
        'ugateway' => [
            'protocol' => env('UG_PROTOCOL', 'http'),
            'host' => env('UG_HOST', 'localhost'),
            'port' => env('UG_PORT', 80),
            'prefix' => env('UG_PREFIX', ''),
        ],
        'payment' => [
            'protocol' => env('PAYMENT_PROTOCOL', 'http'),
            'host' => env('PAYMENT_HOST', 'localhost'),
            'port' => env('PAYMENT_PORT', 80),
            'prefix' => env('PAYMENT_PREFIX', 'api/v1'),
            'auth' => [
                'authenticate_by_default' => false,
            ],
        ],
